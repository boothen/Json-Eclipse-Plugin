...
public class JsonNumber extends JsonEntry {
	...
	private static final String iconPath = "/icons/JsonNumber.gif";
	 ...
	 * @param value
	 */
	public JsonNumber(JsonParent parent, String key, String value) {
	 ...
	 * @param key
	 */
	public JsonNumber(JsonParent parent, String key) {
		super(parent, key);
	}
