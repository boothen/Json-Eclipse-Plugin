...
import org.sourceforge.jsonedit.core.util.reader.JsonFileReader;
	...
	private void doJsonObject() throws JsonReaderException, JsonValidationException {
		...
		do {
			...
			if (ch == openCurly) {
				...
				reportProblem("Expected org.sourceforge.jsonedit.core.core value", new Location(parser.getIFile(),"", parser.getPosition(), parser.getPosition()),0, true);
				throw new JsonValidationException();
			}
