...
public class JsonReconcilingStrategyTest {
	...
	public void testFile33() {
		...
		IDocument doc = FileToDocUtility.getDocument(System.getProperty("user.dir") + "/resources/testfiles/test33.json");
	...
	public void testFile36() {
		...
		IDocument doc = FileToDocUtility.getDocument(System.getProperty("user.dir") + "/resources/testfiles/test36.json");
	...
	public void testFile37() {
		...
		IDocument doc = FileToDocUtility.getDocument(System.getProperty("user.dir") + "/resources/testfiles/test37.json");
	...
	public void testFile38() {
		...
		IDocument doc = FileToDocUtility.getDocument(System.getProperty("user.dir") + "/resources/testfiles/test38.json");
