...
/**
 * JsonTextValidator parses a Json file and validates it. The parser exits when
...
public class JsonTextValidator {
     ...
     */
    private char doJsonObject() throws JsonReaderException, JsonValidationException {
        ...
        do {
            ...
            ch = parser.getNextClean();
            if (ch != colon) {
                reportProblemEndValidation("Expected colon key/value delimiter", new Location(parser.getIFile(), "", parser.getPosition()), 0, true);
            }
     ...
     * @throws JsonValidationException
     */
    private char doJsonArray() throws JsonReaderException, JsonValidationException {
